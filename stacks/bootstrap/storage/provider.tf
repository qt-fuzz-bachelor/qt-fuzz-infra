...
terraform {
  backend "http" {
    address        = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31272/terraform/state/runner-volume"
    lock_address   = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31272/terraform/state/runner-volume/lock"
    unlock_address = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31272/terraform/state/runner-volume/lock"
    lock_method    = "POST"
