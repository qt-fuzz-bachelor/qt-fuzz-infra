...
terraform {
  backend "http" {
    ...
    lock_address   = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31272/terraform/state/fuzzer-network/lock"
    unlock_address = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31272/terraform/state/fuzzer-network/lock"
    lock_method    = "POST"
